...
class IngredienteModelo:
    ...
    def obtenerUno(self, id):
        res = self.__conector.select(tables=["ingrediente"], where=' id_ingrediente=%(id_ingrediente)s', values={"id_ingrediente":id})
        return res
    ...
    def modificar(self, nombre, foto, und_medida, id_ingrediente):
        ...
        res = self.__conector.update("ingrediente", 
                    ...
                    {"nombre": nombre, "foto": foto, "und_medida": und_medida, "id_ingrediente" : id_ingrediente} )
