...
adicion3 = Adicion(13, "tocineta", "workinprogress", "gramos", 213, 1, 10, 9900)
...
itemCarrito2 = ItemCarrito(2, menu2, "sede2", [platoFuerte4])
itemCarrito3 = ItemCarrito(1, menu2, "sede2", [bebida1, platoFuerte3])
